...
public class TablaSimbolos {
    ...
    public static String[] tiposSoportados = {"int", "float", "char", "string"};
    ...
    public static String tipoValor(String st) {
        ...
        String esString = "\"(.)*\"";
        Pattern pString = Pattern.compile(esString);
        Matcher mString = pString.matcher(st);
        ...
        if (mFloat.find() && mFloat.group().equals(st)) {
            ...
            res = "char";
        } else if (mString.find() && mString.group().equals(st)){
            res = "string";
        }
        return res;
    }
